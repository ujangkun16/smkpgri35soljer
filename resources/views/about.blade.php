      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a href="#" class="small mr-3"><span class="icon-whatsapp mr-2"></span>Ofiicial Whatsapp</a> 
          </div>
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.html" class="d-block">
              <img src="images/logo.gif" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="courses.html" class="nav-link text-left">Fasilitas</a>
                </li>
                <li>
                    <a href="contact.html" class="nav-link text-left">Ekstrakulikuler</a>
                </li>
                <li>
