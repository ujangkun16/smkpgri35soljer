...
<head>
  <title>SMK PGRI 35 Solokanjeruk</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">


  <link href="https://fonts.googleapis.com/css?family=Muli:300,400,700,900" rel="stylesheet">
  <link rel="stylesheet" href="master/fonts/icomoon/style.css">
  <link rel="stylesheet" href="master/css/bootstrap.min.css">
  <link rel="stylesheet" href="master/css/jquery-ui.css">
  <link rel="stylesheet" href="master/css/owl.carousel.min.css">
  <link rel="stylesheet" href="master/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="master/css/owl.theme.default.min.css">

  <link rel="stylesheet" href="master/css/jquery.fancybox.min.css">

  <link rel="stylesheet" href="master/css/bootstrap-datepicker.css">

  <link rel="stylesheet" href="master/fonts/flaticon/font/flaticon.css">

  <link rel="stylesheet" href="master/css/aos.css">
  <link href="master/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                    ...
                    <li class="active"><a href="/sarpras">Sarana Prasarana</a></li>
                  </ul>
                <li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('master/master/images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Sarana Prasana</h2>
              <p>Penunjang Pembelajaran</p>
            </div>
          </div>
        </div>
      </div> 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        <figure class="thumnail">
                                <a href="course-single.html"><img src="master/images/course_3.jpg" alt="Image" class="img-fluid"></a>
                        <div class="price">$99.00</div>
                        <div class="category"><h3>Mobile Application</h3></div>  
                        </figure>
                        <div class="course-1-content pb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        <figure class="thumnail">
                                <a href="course-single.html"><img src="master/images/course_4.jpg" alt="Image" class="img-fluid"></a>
                        <div class="price">$99.00</div>
                        <div class="category"><h3>Mobile Application</h3></div>  
                        </figure>
                        <div class="course-1-content pb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        <figure class="thumnail">
                                <a href="course-single.html"><img src="master/images/course_5.jpg" alt="Image" class="img-fluid"></a>
                        <div class="price">$99.00</div>
                        <div class="category"><h3>Mobile Application</h3></div>  
                        </figure>
                        <div class="course-1-content pb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        <figure class="thumnail">
                                <a href="course-single.html"><img src="master/images/course_6.jpg" alt="Image" class="img-fluid"></a>
                        <div class="price">$99.00</div>
                        <div class="category"><h3>Mobile Application</h3></div>  
                        </figure>
                        <div class="course-1-content pb-4">
  ...
  <script src="master/js/jquery-migrate-3.0.1.min.js"></script>
  ...
  <script src="master/js/jquery.stellar.min.js"></script>
  <script src="master/js/jquery.countdown.min.js"></script>
  <script src="master/js/bootstrap-datepicker.min.js"></script>
  <script src="master/js/jquery.easing.1.3.js"></script>
  <script src="master/js/aos.js"></script>
  <script src="master/js/jquery.fancybox.min.js"></script>
  <script src="master/js/jquery.sticky.js"></script>
  <script src="master/js/jquery.mb.YTPlayer.min.js"></script>
